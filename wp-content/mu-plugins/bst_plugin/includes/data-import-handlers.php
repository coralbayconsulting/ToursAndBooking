...
function bst_import_paper_bookings_handler() {
    ...
    $header = array_shift($lines);        foreach ($lines as $line_num => $line) {
        ...
        $booking_data = array(
            ...
            'deposit_payment_status' => function_exists( 'bst_import_line_payment_status' ) ? bst_import_line_payment_status( $deposit_payment_method, $deposit_payment_amount ) : null,
            'balance_payment_method' => $balance_payment_method,
            'balance_payment_amount' => $balance_payment_amount,
            'balance_payment_status' => function_exists( 'bst_import_line_payment_status' ) ? bst_import_line_payment_status( $balance_payment_method, $balance_payment_amount ) : null,
            'additional_payment_method' => $additional_payment_method,
            'additional_payment_amount' => $additional_payment_amount,
            'additional_payment_status' => function_exists( 'bst_import_line_payment_status' ) ? bst_import_line_payment_status( $additional_payment_method, $additional_payment_amount ) : null,
