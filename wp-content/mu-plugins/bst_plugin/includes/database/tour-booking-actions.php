...
function bst_save_tour_booking() {
    ...
    $data = array(
        ...
        'guest1_age' => function_exists('bst_normalize_guest_age') ? bst_normalize_guest_age($_POST['guest1_age'] ?? null) : null,
        ...
        'guest2_age' => function_exists('bst_normalize_guest_age') ? bst_normalize_guest_age($_POST['guest2_age'] ?? null) : null,
